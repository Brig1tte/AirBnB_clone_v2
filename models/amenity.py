...
def __init__(self, name):
    ...
    def __init__(self, name, description, price_by_night, max_guest,
            number_rooms, number_bathrooms, amenity_ids):
    ...
    """ Initialize an instance of PlaceAmenity with given place_id
    and amenity_id """
    super().__init__()
