...
def hello_hbnb():
    """ Functon to print a Message when / is called """
    return 'Hello HBNB!'
...
def python_is_cool(text='is_cool'):
    """ Fucntion to print a Message when /python is called """
    return "Python " + text.replace('_', ' ')


@app.route('/number/<int:n>', strict_slashes=False)
def is_n_number(n):
    """ Funct to print a message when /number is called only if n is an int """
    return "{:d} is a number".format(n)


@app.route('/number_template/<int:n>', strict_slashes=False)
def number_template(n):
    """ Fucntion to display a HTML page only if n is an integer """
